...
function utcFieldsToLocal(dateISO, minutes) {
  ...
  return {
    date: isoDate(d),
    // local getters — this IS the point
...
function WorkSchedulePlanner() {
  ...
  function setRequiredApproversSynced(next) {
    setRequiredApprovers(prev => {
      const resolved = typeof next === "function" ? next(prev) : next;
      if (!isSnapshotMode) trackedApiRequest("PUT", "/required_approvers", {
        names: resolved
      });
      return resolved;
    });
...
`;
  ...
  function approveSelected(val) {
    ...
    setEvents(evs => evs.map(e => {
      ...
      if (nextBy !== by && !isSnapshotMode) trackedApiRequest("PUT", `/events/${e.id}`, {
        approvedBy: nextBy
      });
      return {
        ...e,
  ...
  function onMoveEnd() {
    ...
    if (ms && ms.lastPatch && !isSnapshotMode) {
      ...
      const current = events.find(e => e.id === ms.id) || {
        date: ms.origDate,
        startMinutes: ms.origStart
      };
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u25D1 Offline copy") : pendingSaves > 0 ? /*#__PURE__*/React.createElement("span", {
  ...
  }, "\u25CF Saving\u2026") : hasSaveError ? /*#__PURE__*/React.createElement("span", {
  ...
  }, "\u25CF Not saved") : apiAvailable !== null && /*#__PURE__*/React.createElement("span", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        left: 0,
        right: 0,
        top: peekHours * HOUR_PX - MIDNIGHT_BAR_PX / 2,
        height: MIDNIGHT_BAR_PX,
        zIndex: 1,
        pointerEvents: "none",
      ...
      style: {
        ...
        left: 0,
        right: 0,
        top: (peekHours + 24) * HOUR_PX - MIDNIGHT_BAR_PX / 2,
        height: MIDNIGHT_BAR_PX,
        zIndex: 1,
        pointerEvents: "none",
        background: "repeating-linear-gradient(135deg, #FFFFFF 0 8px, #0A0D10 8px 16px)",
